package com.example.android.myalarmmanager;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DatePickerFragment.DialogDateListener, TimePickerFragment.DialogTimeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editOnceMessage = findViewById(R.id.edt_once_message);
        ...
        editRepeatingMessage = findViewById(R.id.edt_repeating_message);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn_set_once_alarm:
                ...
                String onceMessage = editOnceMessage.getText().toString();
            ...
            case R.id.btn_set_repeating_alarm:
                ...
                String repeatMessage = editRepeatingMessage.getText().toString();
